= IS Blocks FIDO2 SERVER API Guide
IS Blocks Ltd;
:doctype: book
:icons: font
...
This document is about the APIs of the IS Blocks FIDO2 Server application that has been released as open-source.
...
https://github.com/isblocksltd/isblocks-java-fido
